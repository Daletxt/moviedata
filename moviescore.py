...
def load_reviews(path, **kwargs):
    ...
    with open('D://Python//moviedata//ml-100k//u.data','r') as reviews:
...
def relative_path(path):
    ...
    path = os.path.join(dirname, 'D://Python//moviedata//ml-100k//u.item')
    return os.path.normpath('D://Python//moviedata//ml-100k//u.item')
...
def load_movies(path,**kwargs):
    ...
    with open('D://Python//moviedata//ml-100k//u.item','r',errors='ignore') as movies:
